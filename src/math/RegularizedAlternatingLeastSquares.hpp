...
public:
  AlternatingLeastSquaresRegularizationEstimator()
      : swampingThreshold(0.0) {}
  AlternatingLeastSquaresRegularizationEstimator(double swampingThreshold_,
  ...
  double getSwampingThreshold() { return swampingThreshold; }
  ...
  virtual void update(double const swampingFactor) {
    ...
    lambda = (1 - regularizationFriction) * estimatedLambda
...
void fitAlternatingLeastSquaresFactor(Tensor<F> &T,
                                      char const *indicesT,
                                      Tensor<F> &B,
                                      char const idxB,
                                      Tensor<F> &C,
...
template <typename F = double>
void dryFitRegularizedAlternatingLeastSquaresFactor(DryTensor<F> &T,
                                                    char const *indicesT,
                                                    DryTensor<F> &B,
                                                    char const idxB,
                                                    DryTensor<F> &C,
