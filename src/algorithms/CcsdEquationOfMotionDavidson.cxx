...
DEFSPEC(
    ...
    SPEC_IN(
        ...
        {"refreshIterations",
         SPEC_VALUE_DEF("Which iterations it should be refreshed",
                        std::vector<size_t>,
                        std::vector<size_t>({}))},
        {"preconditionerRandom", SPEC_VALUE_DEF("TODO: DOC", bool, false)},
        {"preconditionerSpinFlip", SPEC_VALUE_DEF("TODO: DOC", bool, true)},
        {"structureFactor",
         SPEC_VALUE_DEF("Which eigenvectors should be used to calculate their "
                        "Structure Factor",
                        std::vector<size_t>,
                        std::vector<size_t>({}))},
        {"oneBodyRdm",
         SPEC_VALUE_DEF(
             ...
             std::vector<size_t>({}))},
        {"printEigenvectors",
         SPEC_VALUE_DEF("Which eigenvectors should be printed",
                        std::vector<size_t>,
                        std::vector<size_t>({}))},
